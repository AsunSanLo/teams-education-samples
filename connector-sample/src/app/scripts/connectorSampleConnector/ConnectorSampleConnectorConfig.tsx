...
export interface IConnectorSampleConnectorConfigState extends ITeamsBaseComponentState {
...
export interface IConnectorSampleConnectorConfigProps extends ITeamsBaseComponentProps {
}
...
/**
 * Implementation of the connectorSampleConnector Connector connect page
 */
export class ConnectorSampleConnectorConfig extends TeamsBaseComponent<IConnectorSampleConnectorConfigProps, IConnectorSampleConnectorConfigState> {
        ...
        if (this.inTeams()) {
            ...
            microsoftTeams.settings.registerOnSaveHandler((saveEvent: microsoftTeams.settings.SaveEvent) => {
                ...
                const settings: any = {
                    ...
                    contentUrl: `https://${process.env.HOSTNAME}/connectorSampleConnector/config.html`,
